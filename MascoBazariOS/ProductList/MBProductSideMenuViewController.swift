//
//  MBProductSideMenuViewController.swift
//  MascoBazariOS
//
//  Created by masco bazar on 8/7/21.
//  Copyright © 2021 MascoGroup. All rights reserved.
//

import UIKit

class MBProductSideMenuViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, willDisplayHeaderView view: UIView, forSection section: Int) {
        ...
        header.contentView.backgroundColor = UIColor.colorWithHexString(hexStr: "#424242")
        ...
        headerTapGesture.addTarget(self, action: #selector(MBProductSideMenuViewController.sectionHeaderWasTouched(_:)))
